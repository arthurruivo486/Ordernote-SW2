...
<head>
  ...
  <style>
    ...
    .card-delete { background: #fff; padding: 2rem; border-radius: 1rem; box-shadow: 0 2px 8px rgba(0,0,0,0.1); max-width: 600px; margin: 5rem auto; }
  </style>
</head>
<body>
<div class="container">
  ...
  <div class="card-delete">
    ...
    <p class="mb-4">Tem certeza que deseja excluir o produto abaixo? Essa ação não poderá ser desfeita.</p>
